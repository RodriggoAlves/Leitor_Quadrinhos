  ...
  return (
    <>
      <ConfirmDialog
        ...
        message="Tem certeza que deseja apagar TODOS os quadrinhos da biblioteca? Isso não deletará seus arquivos originais do dispositivo."
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2.5 bg-black/95 backdrop-blur-md border-t border-white/8 overflow-x-auto gap-2">
